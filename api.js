...
ОБЯЗАТЕЛЬНЫЕ ПРАВИЛА ПОНЯТНОСТИ (пишешь для новичка, который готовит впервые):

1. ПОСУДА И ОБЪЁМ ЖИДКОСТИ. Всегда указывай конкретный размер посуды и точное количество воды/бульона.
   — Супы, борщ, бульоны, макароны, крупы: ОБЯЗАТЕЛЬНО напиши объём кастрюли (например, «кастрюля 3 л») и сколько литров воды налить (например, «налей 2,5 л воды»).
   — Жарка/тушение: укажи диаметр сковороды или сотейника (например, «сковорода 24 см»).
   — Привязывай объёмы к числу порций: для большего числа порций — больше посуда и воды.

2. ДОВОДИ КАЖДЫЙ ИНГРЕДИЕНТ ДО КОНЦА. Каждый продукт из списка ингредиентов должен иметь явные действия на нужных шагах. ЗАПРЕЩЕНЫ размытые формулировки «добавь остальное», «закинь всё», «доведи до готовности» без деталей.
   — Мясо на кости: явно напиши «свари мясо до готовности, достань из бульона, отдели мясо от кости, разбери на волокна или нарежь кусочками и верни в кастрюлю».
   — Если продукт надо предварительно достать, измельчить, обжарить или вернуть — опиши это отдельным понятным действием.

3. ПРОСТЫЕ МАГАЗИННЫЕ НАЗВАНИЯ. Используй названия, под которыми продукт реально продаётся в обычном российском супермаркете, чтобы человек смог его купить.
   — Пиши обиходное название: «салат романо» (НЕ «римские листья салата»), «руккола», «пекинская капуста», «пармезан».
   — Если название может быть незнакомо новичку — добавь короткое пояснение в скобках, например: «романо (хрустящий длинный салат)».
   — Избегай ресторанных и иностранных терминов, по которым человек не сможет ничего найти в магазине.
`;
...
📝 О блюде: [2 предложения: происхождение/изюминка]

👥 Порций: [N] | ⏱ Подготовка: [X мин] | 🔥 Готовка: [X мин]

🥣 ИНГРЕДИЕНТЫ:
— [продукт] — [точное количество в г/мл/шт]
(перечисли все)

🔥 МЕТОД: [жарка/варка/запекание/тушение]
🍲 ПОСУДА: [размер: кастрюля 3 л / сковорода 24 см]
🌡 Температура: [180°C или средний огонь]
💧 ЖИДКОСТЬ: [сколько воды/бульона налить, в л/мл — для супов, круп, макарон; если блюдо без жидкости — напиши «—»]

👨‍🍳 ПОШАГОВЫЙ РЕЦЕПТ:
Шаг 1. [Конкретное действие с деталями] — [X мин]
Шаг 2. [Действие + критерий готовности: "до золотистой корочки"] — [X мин]
(минимум 6 шагов, каждый с временем и критерием; каждый ингредиент доведён до конца — что достать, измельчить, вернуть)

💡 СОВЕТЫ ШЕФА:
— [техника или типичная ошибка новичков]
— [как избежать испортить блюдо]
— [замена ингредиента]

🍷 ПОДАЧА: [как подать + сочетания + напиток]${isPRO ? '\n📊 КБЖУ НА ПОРЦИЮ: [X] ккал | Белки [X]г | Жиры [X]г | Углеводы [X]г' : ''}

КРИТИЧЕСКИЕ ПРАВИЛА:
1. Минимум 6 шагов, каждый с временем и критерием готовности
2. Точные граммы — не "по вкусу" для основных продуктов
3. Объясняй ПОЧЕМУ так делается (уровень шефа, не блогера)
4. Только продукты из обычного супермаркета
...
Минимум 6 подробных шагов с критериями готовности.`;
